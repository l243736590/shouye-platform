...
建议顺序：先办 ARC 预约和学校证明；拿到 ARC 后去学校合作银行开户；再用本人名义手机号和银行账户做实名认证。`,
  ...
  },
  {
    ...
    author: '高丽大学兼职申请过',
    identity: '本科',
    content: `D-2/D-4 不是自动允许打工，原则上要先拿学校确认，再向出入境申请“时间制就业许可”。没许可直接打工，最麻烦的不是被扣工资，而是影响签证。

1. 先确认自己是否符合资格：签证类型、入境/在学时间、成绩/出勤、韩语能力、是否超学期。部分学校明确提示，超学期或未满足毕业条件的学生可能不能申请兼职许可。
2. 常见流程：找到雇主 → 签劳动合同或拿雇佣确认 → 学校国际处/负责老师确认 → HiKorea 或出入境提交时间制就业申请 → 许可下来后再开始工作。
3. 常见材料：申请表、护照、外国人登录证、在学证明、成绩/出勤材料、雇佣合同、营业执照、学校确认书、TOPIK/KIIP/韩语能力证明等。
4. 小时数不是所有人都一样。Study in Korea 和学校国际处资料都强调与签证、课程、韩语能力、学历阶段有关；有些本科/大学院、平日/周末/假期规则不同。先按自己学校国际处最新表格核对。
5. 禁止或高风险工作要避开：娱乐场所、配送/代驾、上门销售、部分私教/儿童外语教育、与学生身份不符或安全风险高的工作。具体禁限行业以出入境公告为准。

实操建议：入职前把“许可开始日、许可工作地点、每周小时、工资、工作内容”都写清楚。换老板、换地点、加班超时，都可能需要重新处理。`,
    likes: 44,
    accepted: true,
    createdAt: '2026-04-29',
  },
