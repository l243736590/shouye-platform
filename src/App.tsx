...
const partnerShowcases = [
  ...
  {
    type: '学业相关',
    audience: '韩语写作、发表准备、课业答疑和选课支持',
    tone: 'academic',
    merchants: [
      {
        name: '论文辅导与课业支持',
        logo: '学业',
        summary: '韩语写作、发表准备、课业答疑和选课支持',
        description: '展示可合法合规提供的学业帮助范围，重点说明导师背景、服务语言、交付方式和边界。',
        tags: ['论文', '选课', 'TOPIK'],
      },
      {
        name: 'TOPIK 写作训练',
      ...
      },
      {
        name: '专业课答疑工作室',
        logo: '答疑',
        summary: '经营、传媒、设计、计算机等课程理解支持',
        description: '重点展示可辅导科目、语言能力、服务边界和预约方式，避免学生把合法辅导误解成代写代做。',
        tags: ['专业课', '答疑', '预约'],
      },
    ],
  },
